...
- When converting a binary number to an 8-bit 1's or 2's complement, such as $01001010_2$, the result is simply $01001010_{1s}$ and $01001010_{2s}$. You only negate the bits or add one after negation (for the 2's complement) when you need to find the negative value $-(01001010_2)$, which, for example, is $10110110_{2s}$.
