...
- **Fundamental Theorem of Calculus:** If _F_ is an anti-derivative of _f_, $\displaystyle\int_a^b f(x)dx = F(b) - F(a)$ or $\displaystyle\frac{d}{dx} \displaystyle\int_a^x f(t)dt = f(x)$.
